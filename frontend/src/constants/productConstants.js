...
export const PRODUCT_BY_CATEGORY_REQUEST =
  'PRODUCT_BY_CATEGORY_REQUEST';
export const PRODUCT_BY_CATEGORY_SUCCESS =
  'PRODUCT_BY_CATEGORY_SUCCESS';
export const PRODUCT_BY_CATEGORY_FAIL = 'PRODUCT_BY_CATEGORY_FAIL';

export const PRODUCT_BY_SUBCATEGORY_REQUEST =
  'PRODUCT_BY_SUBCATEGORY_REQUEST';
export const PRODUCT_BY_SUBCATEGORY_SUCCESS =
  'PRODUCT_BY_SUBCATEGORY_SUCCESS';
export const PRODUCT_BY_SUBCATEGORY_FAIL =
