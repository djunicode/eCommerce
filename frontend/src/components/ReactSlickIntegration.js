...
//             .
//           </p>
//           <p>In-place enlargement for mouse and touch input.</p>
//           <p>
//             Side-by-side enlargement supported, please see&nbsp;
//             <Link to="/external">External Enlarged Image Demo</Link>.
//           </p>
//           <p>Responsive and fluid between breakpoints.</p>
//           <p>
//             Initial file size optimized via
//             <SpacedSpan className="code">srcset</SpacedSpan>
//             and
//             <SpacedSpan className="code">sizes</SpacedSpan>
//             attributes.
//           </p>
//           <p>
//             Please see
